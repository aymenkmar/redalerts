<div>
    <h1 class="text-2xl font-bold mb-6">Ingress Classes</h1>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($ingressClasses as $ingressClass)
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                            {{ $ingressClass['metadata']['name'] }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            {{ $ingressClass['spec']['controller'] ?? 'N/A' }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            @if(isset($ingressClass['metadata']['annotations']['ingressclass.kubernetes.io/is-default-class']) && $ingressClass['metadata']['annotations']['ingressclass.kubernetes.io/is-default-class'] === 'true')
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            {{ $this->formatAge($ingressClass['metadata']['creationTimestamp']) }}
                        </td>
                    </tr>
                    @empty
                    <tr>
