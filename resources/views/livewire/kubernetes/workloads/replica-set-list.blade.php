<div>
    <h1 class="text-2xl font-bold mb-6">Replica Sets</h1>
    ...
    <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center mb-6">
        ...
        @include('livewire.kubernetes.components.search-input', ['placeholder' => 'Search replica sets...'])
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($replicaSets as $replicaSet)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            {{ $this->formatAge($replicaSet['metadata']['creationTimestamp']) }}
                        </td>
                    </tr>
                    @empty
                    <tr>
